...
const ShopCard = ({ item, menuOptions, handleViewShop }: {item: any; menuOptions: any; handleViewShop: (item: any) => void; }) => {
  console.log("ShopCard rendered for item:", item); // Debug log to check rendering
